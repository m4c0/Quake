...
void SV_SendServerinfo (client_t *client)
{
	...
	if (!coop.to_bool() && deathmatch.to_bool())
...
//
	if (coop.to_bool())
		deathmatch = "0";
	current_skill = (int)(skill.to_float() + 0.5);
	if (current_skill < 0)
		current_skill = 0;
	if (current_skill > 3)
		current_skill = 3;
...
//	
	...
	if (coop.to_bool())
		pr_global_struct->coop = coop.to_bool();
	else
		pr_global_struct->deathmatch = deathmatch.to_bool();
